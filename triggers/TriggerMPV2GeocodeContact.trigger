/*******Trigger Name : TriggerMPV2GeocodeContact  Author : Shilpa kamble Date : 25/8/2015 Details : Dynamically generated tigger on object to insert,update & delete the map point *********************************/
Trigger TriggerMPV2GeocodeContact on Contact(after Update, before delete, after insert, after undelete, after delete) {
     String CSName = 'Extentia_SIM__MapPlotterTriggerSettings__c';
    String fldName = 'Extentia_SIM__Bypass_Trigger__c';
    String triggerName = 'Bypass Contact Trigger';
    boolean skip = false;
    ...
    List<MP_CustomMapping__c> mappinglist = Helper_SOQL.GetMappedObject('Contact');
